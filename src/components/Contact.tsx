...
export default function Contact() {
  ...
  <p className="font-mono text-[12px] text-secondary uppercase tracking-[0.2em] flex items-center gap-2">
    Contacto
        ...
        <div className="flex flex-col gap-4 font-ibm-plex text-[14px] tracking-tight">
    <div className="flex gap-8">
      <a 
        href="https://linkedin.com/in/agustina-armendariz" 
        target="_blank" 
        className="text-secondary hover:text-ink transition-all duration-300 border-b border-transparent hover:border-ink pb-1 uppercase text-[10px] font-mono tracking-widest"
      >
        LinkedIn ↗
      </a>
      <a 
